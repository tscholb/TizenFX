...
namespace Tizen.NUI
{
    ...
    internal class NUIWindowProxy : IWindowProxy
    {
        ...
        {
            Tizen.Log.Error("MYLOG","tscholb : InitializeWindow !! ResourceId : " + ResourceId.ToString());
            window.WindowSize = new Size(width, height);
            Tizen.Log.Error("MYLOG","tscholb : InitializeWindow !! window Size: " + width + "x" + height);
        }
