...
namespace WidgetApplicationTemplate
{
    class Program : NUIApplication
    {
        ...
        void Initialize()
        {
            ...
            mTimer.Tick += onTick;
            // Match dali-ui: no automatic lifecycle changes during measurement.
            // Press 2 to enable the add/remove test explicitly.
        ...
        private bool onTick(object o, Timer.TickEventArgs e)
        {
            ...
            else
            {
                ...
                mWidgetView2 = WidgetViewManager.Instance.AddWidget("class2@Tizen.NUI.WidgetTest", encodedBundle, baseWidgetSize, baseWidgetSize, 0.0f);
                widgetArea.Add(mWidgetView2);
                UpdateWidgetBounds();
        ...
        public void OnKeyEvent(object sender, Window.KeyEventArgs e)
        {
            if (e.Key.State == Key.StateType.Down )
            {
                ...
                if (e.Key.KeyPressedName == "2")
                {
                    ...
                    statusLabel.Text = "NUI provider | Auto add/remove: " + (autoToggleEnabled ? "on" : "off");
                }
